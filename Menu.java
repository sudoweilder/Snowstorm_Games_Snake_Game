...
public class Menu {
    ...
    public static void boardSize(Scanner console) { 
        ...
        if (choice == 1) Game.panelWidth = 300; //Smallest 15x15
        else if (choice == 2) Game.panelWidth = 500; // Medium (Defult) 25x25
        else if (choice == 3) Game.panelWidth = 700; // Large 35x35
